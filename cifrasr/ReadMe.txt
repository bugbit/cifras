========================================================================
    APLICACIÓN DE CONSOLA: cifrasrecursivo 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación cifrasrecursivo.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación cifrasrecursivo.


cifrasrecursivo.vcxproj
...
cifrasrecursivo.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado cifrasrecursivo.pch y un archivo de tipos 
